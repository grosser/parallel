...
Here are a few notable options.
 ...
 - [Configuration] You can set the environment variable `PARALLEL_OVERRIDE_PROCESSOR_COUNT` to use a custom default value of procesess / threads instead of the number of processors detected. This can be useful to reconfigure a tool using parallel without inserting custom logic in it.
